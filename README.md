...
> You need to put the sidebar.quick-actions.enable setting to false if you're on a 1080p monitor to make the sidebar fit. A better solution for this is WIP.
